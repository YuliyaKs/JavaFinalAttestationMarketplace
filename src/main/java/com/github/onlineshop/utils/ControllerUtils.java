package com.github.onlineshop.utils;
...
public class ControllerUtils {
    ...
    // Добавление алерт-сообщения и возврат URL страницы
    ...
    // Вычисление массива номеров для нумерации страниц
